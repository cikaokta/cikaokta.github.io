    ...
    <div class="panel-body">
        <table class="table table-bordered">
            ...
            <td><?php if($row->gambar == null){
                   echo "Tidak Ada Gambar";  }else{?><img src="gambar/<?=$row->gambar?>" width="250px" height="150px">
                <?php }?>
            </td>
            </tr>
            <tr>
            <td>Rekomendasi<br>Merk Dagang</td>
            <td><?php if($row->merk == null){
                   echo "Tidak Ada Gambar";  }else{?><img src="gambar/<?=$row->merk?>" width="250px" height="250px">
                <?php }?>
            </td>
            </tr>
        </table>
        ...
        <p>
            <a class="btn edit" href="index.php?m=konsul_lagi"><span class=""></span> Konsultasi Lagi</a>
